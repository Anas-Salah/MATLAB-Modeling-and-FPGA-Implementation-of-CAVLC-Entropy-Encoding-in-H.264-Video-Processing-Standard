...
## LEDs
set_property -dict { PACKAGE_PIN T28   IOSTANDARD LVCMOS33 } [get_ports { O }]; #IO_L11N_T1_SRCC_14 Sch=led[0]
...
## Switches
set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS12 } [get_ports { I }]; #IO_0_17 Sch=sw[0]
